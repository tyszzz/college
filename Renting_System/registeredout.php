...
<table border="0" width="23%">
	...
	<td align="left"><input type=text maxLength="8" size="20" name="taxid" required="required"></td>
	</tr>
	...
	<td align="left"><input type=text maxLength="30" size="15" name="sqution" required="required">(密碼丟失時使用)</td>
	</tr>
